...
export default function SingleOrganizedEvent() {
  ...
  return (
    <div className="w-full flex flex-col items-center gap-20">
      <div className="bg-slate-600/20 rounded-xl p-10 w-7/12 flex flex-col justify-center items-center gap-8 backdrop-blur-sm border border-gray-400/20 text-lg">
